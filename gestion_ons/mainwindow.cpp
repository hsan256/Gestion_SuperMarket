...
void MainWindow::on_ajouterPromo_clicked(){
    ...
    if(taux_Promotion > 100 || taux_Promotion < 0){
        control= false;
        QMessageBox::critical(nullptr, QObject::tr("Failed :(!"),
    ...
    ui->prix_Promotion->clear();
    ui->taux_Promotion->clear();
    ui->numProduit->clear();
}
...
void MainWindow::on_modifierpromotion_clicked()
{
    ...
    ui->prix_Promotion_2->clear();
    ui->taux_PromotionModif->clear();
    ui->numProduitModif->clear();
}
